...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[42rem] md:h-[52rem] flex items-center justify-center relative p-2 md:p-10"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-[1250px] -mt-10 mx-auto w-full aspect-[16/9] min-h-[620px] border-4 border-[#6C6C6C] p-2 md:p-6 bg-[#222222] rounded-[30px] shadow-2xl"
    >
