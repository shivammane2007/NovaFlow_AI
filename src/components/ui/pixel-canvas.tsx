...
// Ensure the web component is only defined on the client side
if (typeof window !== "undefined") {
    class PixelCanvasElement extends HTMLElement {
      ...
      `
        ...
        get colors() {
            // Default to the premium theme colors (gold, dark charcoal, lighter gold)
            return this.dataset.colors?.split(",") || ["#d4af37", "#1f1f1f", "#eaddb6", "#2a2a2a"]
        }
